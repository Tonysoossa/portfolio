...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center  max-w-4xl mx-auto">
      <h1 className="text-5xl sm:text-6xl text-center font-bold mb-4 text-animated dark:text-white h-16">
        Servanin Tony
      </h1>
      <h2 className="text-2xl sm:text-3xl dark:text-blue-400 mb-6 text-center text-animated">
        Javascript React Frontend Developer
      </h2>
      <p className="text-center text-lg sm:text-xl max-w-4xl mb-8 text-fadeInUp dark:text-gray-300">
