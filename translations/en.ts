const en = {
  ...
  resume: {
    ...
    education: {
      title: "Education",
      degres: {
        Sncf: "HTML/CSS/Javascript online training",
        ocr: "Javascript Web Integrator Level 5 degre",
      },
      dateCodeWars: "2022-Present",
    },
    ...
    cv: "Curriculum Vitae and Professional Profile",
  ...
  error: {
    ...
    infoMessage2: "Your request did not successed.",
    retryBtn: "Try again",
